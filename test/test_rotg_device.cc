...
void test_rotg_device_work( Params& params, bool run )
{
    ...
    // setup
    std::vector<TX> a( n ), aref( n ), a_in( n );
    std::vector<TX> b( n ), bref( n ), b_in( n );
    std::vector<TX> s( n ), sref( n );
...
void test_rotg_device( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_rotg_device_work< float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_rotg_device_work< double >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_rotg_device_work< std::complex<float> >( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_rotg_device_work< std::complex<double> >( params, run );
            break;
