...
Params::Params():
    ...
    dim       ( "dim",     6,    PT_List,            0,     1e9, "m by n by k dimensions" ),
    alpha     ( "alpha",   9, 4, PT_List,    pi,  -inf,     inf, "scalar alpha" ),
    beta      ( "beta",    9, 4, PT_List,     e,  -inf,     inf, "scalar beta" ),
    ...
    pointer_mode( "pointer-mode", 3, PT_List, 'h', "hd",          "h=host, d=device" ),
