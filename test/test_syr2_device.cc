...
void test_syr2_device_work( Params& params, bool run )
{
    ...
    // test error exits
    assert_throw( blas::syr2( Layout(0), uplo,     n, alpha, dx, incx, dy, incy, dA, lda, queue ), blas::Error );
    assert_throw( blas::syr2( layout,    Uplo(0),  n, alpha, dx, incx, dy, incy, dA, lda, queue ), blas::Error );
    assert_throw( blas::syr2( layout,    uplo,    -1, alpha, dx, incx, dy, incy, dA, lda, queue ), blas::Error );
    assert_throw( blas::syr2( layout,    uplo,     n, alpha, dx,    0, dy, incy, dA, lda, queue ), blas::Error );
    assert_throw( blas::syr2( layout,    uplo,     n, alpha, dx, incx, dy,    0, dA, lda, queue ), blas::Error );
    assert_throw( blas::syr2( layout,    uplo,     n, alpha, dx, incx, dy, incy, dA, n-1, queue ), blas::Error );
    ...
    blas::syr2( layout, uplo, n, alpha, dx, incx, dy, incy, dA, lda, queue );
    queue.sync();
    time = get_wtime() - time;
...
void test_syr2_device( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_syr2_device_work< float, float, float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_syr2_device_work< double, double, double >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_syr2_device_work< std::complex<float>, std::complex<float>,
                            std::complex<float> >( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_syr2_device_work< std::complex<double>, std::complex<double>,
