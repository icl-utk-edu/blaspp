...
void test_symv_device_work( Params& params, bool run )
{
    ...
    // test error exits
    assert_throw( blas::symv( Layout(0), uplo,     n, alpha, dA, lda, x, incx, beta, y, incy, queue ), blas::Error );
    assert_throw( blas::symv( layout,    Uplo(0),  n, alpha, dA, lda, x, incx, beta, y, incy, queue ), blas::Error );
    assert_throw( blas::symv( layout,    uplo,    -1, alpha, dA, lda, x, incx, beta, y, incy, queue ), blas::Error );
    assert_throw( blas::symv( layout,    uplo,     n, alpha, dA, n-1, x, incx, beta, y, incy, queue ), blas::Error );
    assert_throw( blas::symv( layout,    uplo,     n, alpha, dA, lda, x,    0, beta, y, incy, queue ), blas::Error );
    assert_throw( blas::symv( layout,    uplo,     n, alpha, dA, lda, x, incx, beta, y,    0, queue ), blas::Error );
