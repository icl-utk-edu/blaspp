    ...
    blas::Queue& queue )
{
    ...
    blas_error_if( incy == 0 );
        ...
        counter::dev_syr2_type element;
        memset( &element, 0, sizeof( element ) );
        element = { uplo, n };
        counter::insert( element, counter::Id::dev_syr2 );
    ...
    // cuBLAS, rocBLAS, and oneMKL all have [cz]syr2, so no syr2k is needed.
    internal::syr2( uplo, n_, alpha, x, incx_, y, incy_, A, lda_, queue );
#endif
}
