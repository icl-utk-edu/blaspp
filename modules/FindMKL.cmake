#taken from https://gist.github.com/scivision/5108cf6ab1515f581a84cd9ad1ef72aa
...
if(NOT BUILD_SHARED_LIBS)
    ...
    set(LP_LIB "libmkl_intel_lp64.a")
    set(GNU_INT_LIB "libmkl_gf_ilp64.a")
    set(GNU_LP_LIB "libmkl_gf_lp64.a")

    set(SEQ_LIB "libmkl_sequential.a")
    set(THR_LIB "libmkl_intel_thread.a")
    set(GNU_THR_LIB "libmkl_gnu_thread.a")

    set(COR_LIB "libmkl_core.a")
else()
    set(INT_LIB "mkl_intel_ilp64")
    set(LP_LIB "mkl_intel_lp64")
    set(GNU_INT_LIB "mkl_gf_ilp64")
    set(GNU_LP_LIB "mkl_gf_lp64")

    set(SEQ_LIB "mkl_sequential")
    set(THR_LIB "mkl_intel_thread")
    set(GNU_THR_LIB "mkl_gnu_thread")

    set(COR_LIB "mkl_core")
endif()

#message("checking mklroot/include: $ENV{MKLROOT}/include")
message("mkl int lib: ${INT_LIB}")
...
# added by Jamie Finney
if(0)
if(MKL AND NOT TARGET MKL::MKL)
