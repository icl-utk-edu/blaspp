...
if (does_contain)
    ...
    if (OpenMP_CXX_FOUND)
        ...
        if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
            if (NOT ${BLAS_LIBRARY_MKL} MATCHES "Intel ifort conventions"
                AND NOT ${BLAS_LIBRARY_THREADING} MATCHES "sequential"
                AND NOT ${BLAS_LIBRARY_INTEGER} MATCHES "\\(ILP64")
            ...
            if (NOT ${BLAS_LIBRARY_MKL} MATCHES "Intel ifort conventions"
                AND NOT ${BLAS_LIBRARY_THREADING} MATCHES "sequential"
                AND NOT ${BLAS_LIBRARY_INTEGER} MATCHES "\\(LP64")
        ...
        elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
            if (NOT ${BLAS_LIBRARY_MKL} MATCHES "GNU gfortran conventions"
                AND NOT ${BLAS_LIBRARY_THREADING} MATCHES "sequential"
                AND NOT ${BLAS_LIBRARY_INTEGER} MATCHES "\\(ILP64")
    ...
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
        if (NOT ${BLAS_LIBRARY_MKL} MATCHES "GNU gfortran conventions"
            AND NOT ${BLAS_LIBRARY_THREADING} MATCHES "threaded"
            AND NOT ${BLAS_LIBRARY_INTEGER} MATCHES "\\(ILP64")
...
if (DEBUG)
    ...
    message( "fortran mangling: ${FORTRAN_MANGLING_DEFINES}" )
